...
| 260811-ek0 | Corregir inconsistencia de SLA en `IdentityGateComponent` (estado `en_revision`): decía "1-3 días hábiles", contradiciendo el copy correcto de `IdentitySumsubModalComponent` ("hasta 24 horas") para el mismo estado — encontrado auditando el copy de Fase 1-5 contra `Service_Blueprint_Diagrama_Fase_5.md`. Rama Fase 0 (72h) intacta a propósito | 2026-08-11 | e829261 | [260811-ek0-corregir-inconsistencia-de-sla-en-identi](./quick/260811-ek0-corregir-inconsistencia-de-sla-en-identi/) |
| 260811-mk6 | Cerrar 3 brechas entre los estados reales de Truora Colombia (Figma "Cuenta V2.0.0") y Fase 1-5, en blueprint y prototipo: checklist de screen1 pasa de 5 a 8 ítems (GPS/VPN/"vuelve a Dropi" primero); contador de 3 intentos + cooldown de 10 min con temporizador visible para rechazo de documento (resuelve el 🚧 "catálogo de causas" del blueprint C6); aviso "¿Sigues ahí?" tras 10 min de inactividad vía `IdentityModalService`, nuevo en blueprint C5 y prototipo, con botón de demo en el switcher Fase 1-5 | 2026-08-11 | 1ec6576 | [260811-mk6-cerrar-3-brechas-truora-co-vs-fase-1-5-c](./quick/260811-mk6-cerrar-3-brechas-truora-co-vs-fase-1-5-c/) |
| 260811-nnt | Corregir rótulo Nuevo/Activo consciente de fase: el toggle "TIPO DE USUARIO" del panel superior mostraba vocabulario de Fase 0 ("Etapa 0"/"Etapa 0.5") incluso en modo Fase 1-5, donde "activo" significa 20+ órdenes (criterio distinto). Nueva `FASE15_TIPO_USUARIO_LABELS`, etiqueta ramificada por `faseProyecto()`; sección "Tipo de usuario" agregada al switcher de Fase 1-5 (mismo patrón ya usado en el de Fase 0) + backstage-dots en los 5 chips de Estado de identidad conectándolos con el proceso real de Truora/Sumsub | 2026-08-11 | add0fe0 | [260811-nnt-corregir-rotulo-nuevo-activo-consciente-](./quick/260811-nnt-corregir-rotulo-nuevo-activo-consciente-/) |
| 260812-km0 | Reducir densidad visual de las cajas de `Service_Blueprint_Diagrama_Fase_5.html`: padding/line-height/márgenes más compactos en `.box`/`.copy-line`/`.format-tag` (una sola regla CSS compartida por todas las cajas del documento), sin tocar font-size ni acortar contenido | 2026-08-12 | bdcd9bd | [260812-km0-reducir-la-altura-densidad-visual-de-las](./quick/260812-km0-reducir-la-altura-densidad-visual-de-las/) |
| 260812-kqt | Limitar el ancho máximo de las cajas de `Service_Blueprint_Diagrama_Fase_5.html` a 600px (`max-width` en `.box`, sin tocar `grid-template-columns`). Nota: el commit también incluye una reubicación de la sección "Matrices de referencia rápida" que ya estaba en el archivo en disco al leerlo — no generada por esta tarea, sin pérdida ni duplicación de contenido (verificado) | 2026-08-12 | fe2b3c9 | [260812-kqt-limitar-el-ancho-maximo-de-las-cajas-del](./quick/260812-kqt-limitar-el-ancho-maximo-de-las-cajas-del/) |
...
Last activity: 2026-08-12 -- Completed quick task 260812-kqt: Limitar el ancho maximo de las cajas de Service_Blueprint_Diagrama_Fase_5.html a 600px
