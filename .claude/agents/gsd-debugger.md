...
<required_reading>
@D:/validacion-identidad/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/validacion-identidad/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/validacion-identidad/.claude
                  → checks D:/validacion-identidad/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/validacion-identidad/.claude/get-shit-done
                  → writes to D:/validacion-identidad/.claude/get-shit-done/hooks/
...
@D:/validacion-identidad/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/validacion-identidad/.claude/get-shit-done/references/common-bug-patterns.md
