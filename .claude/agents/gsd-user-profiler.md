...
<reference>
@D:/validacion-identidad/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/validacion-identidad/.claude/get-shit-done/references/user-profiling.md` to load:
