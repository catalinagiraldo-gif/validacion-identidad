...
Use template from `D:/validacion-identidad/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/validacion-identidad/.claude/get-shit-done/templates/UI-SPEC.md`
