...
Reference full template: `D:/validacion-identidad/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/validacion-identidad/.claude/get-shit-done/templates/state.md`.
