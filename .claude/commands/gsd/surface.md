...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/validacion-identidad/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=D:/validacion-identidad/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=D:/validacion-identidad/.claude/commands/gsd
AGENTS_DIR=D:/validacion-identidad/.claude/agents
```
...
<execution_context>
Surface state file: `D:/validacion-identidad/.claude/skills/.gsd-surface.json`
Install profile marker: `D:/validacion-identidad/.claude/skills/.gsd-profile`
Engine module: `D:/validacion-identidad/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/validacion-identidad/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
