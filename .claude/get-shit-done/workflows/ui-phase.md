...
```markdown
Read D:/validacion-identidad/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/validacion-identidad/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/validacion-identidad/.claude/agents/gsd-ui-checker.md for instructions.
