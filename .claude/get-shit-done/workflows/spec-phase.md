...
```bash
INIT=$(node "D:/validacion-identidad/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/validacion-identidad/.claude/get-shit-done/templates/spec.md.
