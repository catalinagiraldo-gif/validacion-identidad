...
```bash
INIT=$(node "D:/validacion-identidad/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/validacion-identidad/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
