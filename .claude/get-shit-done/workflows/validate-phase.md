...
```
Agent(
  prompt="Read D:/validacion-identidad/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/validacion-identidad/.claude/get-shit-done/templates/VALIDATION.md`
