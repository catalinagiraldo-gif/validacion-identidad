...
- **Enrutamiento de soporte (Bloqueo, Pendiente-en-revisión, Rechazado):** los 3 puntos de contacto del blueprint ahora abren el mismo widget de soporte flotante existente en su menú raíz, sin deep-link técnico a una opción específica — la orientación hacia la opción correcta depende del copy de cada modal, no de una integración. Pendiente-en-revisión pasa a tener un botón secundario "Contactar a soporte" junto a "Entendido" (antes no ofrecía ninguna vía de contacto). El árbol completo de 8 opciones que ese widget debe resolver para este flujo vive en `Soporte-Validacion-Identidad.md`.
